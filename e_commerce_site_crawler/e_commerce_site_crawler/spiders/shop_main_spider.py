...
from e_commerce_site_crawler.ecommerce.pageParser.shopping_itemsList_parser import analysis_method_selector,analysis_goods_list
...
from e_commerce_site_crawler.ecommerce.pageParser.shopping_detail_parser import *
